<?php
	...
	if (isset($_POST["export_excel"])) {
			$sql = "SELECT * FROM tbl_b2b, tbl_users WHERE tbl_users.register_id = tbl_b2b.register_id";
			...
			if(mysqli_num_rows($result) > 0){
				...
				header("Content-Disposition: attachment; filename=all_b2b.xls");
				echo $output;
			}
		}
?>