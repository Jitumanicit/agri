            	...
            	<div class="table-responsive">
                    ...
                    <tbody style="font-size: 14px;">
                        <?php
                            ...
                            $sql="SELECT * FROM tbl_users, tbl_b2b, tbl_meeting WHERE tbl_users.register_id = tbl_b2b.register_id AND tbl_b2b.register_id = tbl_meeting.reciver_register_id AND tbl_meeting.sender_register_id = '".$_SESSION['register_id']."'";
                            $res = $link->query($sql);
