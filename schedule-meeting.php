...
<section class="welcome-section" style="padding-top: 30px;">
    <div class="container">
        <div class="sec-title-two">
            <h2 style="font-size: 20px;">Your schedule meeting with delegates</h2>
            	...
            	<div class="table-responsive">
                    ...
                    <tbody style="font-size: 14px;">
                        <?php
                            ...
                            $sql="SELECT * FROM tbl_users, tbl_meeting WHERE tbl_users.register_id = tbl_meeting.reciver_register_id AND tbl_meeting.activation_status = 1 AND tbl_meeting.sender_register_id = '".$_SESSION['register_id']."'";
                            $res = $link->query($sql);
